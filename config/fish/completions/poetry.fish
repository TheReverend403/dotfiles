...
complete -c poetry -n '__fish_poetry_a811c429ecd75b53_complete_no_subcommand' -l verbose -d 'Increase the verbosity of messages: "-v" for normal output, "-vv" for more verbose output and "-vvv" for debug'
complete -c poetry -n '__fish_poetry_a811c429ecd75b53_complete_no_subcommand' -l version -d 'Display this application version'

# commands
complete -c poetry -f -n '__fish_poetry_a811c429ecd75b53_complete_no_subcommand' -a about -d 'Shows information about Poetry.'
complete -c poetry -f -n '__fish_poetry_a811c429ecd75b53_complete_no_subcommand' -a add -d 'Adds a new dependency to pyproject.toml.'
...
complete -c poetry -f -n '__fish_poetry_a811c429ecd75b53_complete_no_subcommand' -a cache -d 'Interact with Poetry\'s cache'
...
complete -c poetry -f -n '__fish_poetry_a811c429ecd75b53_complete_no_subcommand' -a config -d 'Manages configuration settings.'
complete -c poetry -f -n '__fish_poetry_a811c429ecd75b53_complete_no_subcommand' -a debug -d 'Debug various elements of Poetry.'
complete -c poetry -f -n '__fish_poetry_a811c429ecd75b53_complete_no_subcommand' -a env -d 'Interact with Poetry\'s project environments.'
complete -c poetry -f -n '__fish_poetry_a811c429ecd75b53_complete_no_subcommand' -a export -d 'Exports the lock file to alternative formats.'
complete -c poetry -f -n '__fish_poetry_a811c429ecd75b53_complete_no_subcommand' -a help -d 'Display the manual of a command'
...
complete -c poetry -f -n '__fish_poetry_a811c429ecd75b53_complete_no_subcommand' -a self -d 'Interact with Poetry directly.'
...
complete -c poetry -f -n '__fish_poetry_a811c429ecd75b53_complete_no_subcommand' -a update -d 'Update the dependencies as according to the pyproject.toml file.'
complete -c poetry -f -n '__fish_poetry_a811c429ecd75b53_complete_no_subcommand' -a version -d 'Shows the version of the project or bumps it when a validbump rule is provided.'
